...
function KidsPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "linear-gradient(180deg, oklch(0.15 0.06 300), oklch(0.05 0.005 260) 40%)" }}>
      ...
      <div className="pt-24 lg:pt-28 pb-8 px-6 lg:px-12">
        <h1 className="text-4xl lg:text-6xl font-black" style={{ color: "oklch(0.7 0.2 330)" }}>
          🧸 Kids
        </h1>
        <p className="text-muted-foreground mt-3 text-base lg:text-lg">Conteúdo seguro e divertido para toda a família</p>
      </div>
